...
load_schedules = importlib.import_module(
    "app.001 Scheduler.schedule_store"
).load_schedules
    ...
    def test_registers_jobs_from_database_rows(self):
        ...
        async def fetch(_query, sched_types):
            return [
                ...
                for row in SCHEDULE_ROWS.get(sched_type, [])
            ]
