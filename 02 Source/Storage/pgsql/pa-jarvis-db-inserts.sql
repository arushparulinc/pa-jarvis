...
INSERT INTO config.llm_system_instructions(instrc_type, instruction, instrc_priority, agent_id) VALUES('PURPOSE', 'Act as Master Router Agent and use available specialized agents as and when required', 20, 1);
INSERT INTO config.llm_system_instructions(instrc_type, instruction, instrc_priority, agent_id) VALUES('PURPOSE', 'Call the appropriate agent as a tool call, and pass the user request prompt as parameter', 21, 1);
INSERT INTO config.llm_system_instructions(instrc_type, instruction, instrc_priority, agent_id) VALUES('AGENTS', 'Google Drive Agent: Manages uploads, downloads and searches on google drive', 30, 1);
INSERT INTO config.llm_system_instructions(instrc_type, instruction, instrc_priority, agent_id) VALUES('AGENTS', 'Personal Tools Agent: Manages personal facts, quotes, pics, videos', 31, 1);
INSERT INTO config.llm_system_instructions(instrc_type, instruction, instrc_priority, agent_id) VALUES('AGENTS', 'Internet Tools Agent: Handles all internet searches and online API calls', 32, 1);
INSERT INTO config.llm_system_instructions(instrc_type, instruction, instrc_priority, agent_id) VALUES('AGENTS', 'Comm Channels Agent: Sends information to variouls communication channels', 33, 1);
...
INSERT INTO config.llm_system_instructions(instrc_type, instruction, instrc_priority, agent_id) VALUES('PURPOSE', 'You are responsible for executing various actions on user personal systems and data', 20, 3);

-- ADD TOOLS
INSERT INTO config.tools_registry(tool_id, tool_name, tool_description, agent_id) VALUES(101, 'Google Drive Agent', 'Manages uploads, downloads and searches on google drive', 1);
INSERT INTO config.tools_registry(tool_id, tool_name, tool_description, agent_id) VALUES(102, 'Personal Tools Agent', 'Executes actions for user on specific personal spaces', 1);
INSERT INTO config.tools_registry(tool_id, tool_name, tool_description, agent_id) VALUES(103, 'Internet Tools Agent', 'Handles all internet searches and online API calls', 1);
INSERT INTO config.tools_registry(tool_id, tool_name, tool_description, agent_id) VALUES(104, 'Comm Channels Agent', 'Sends information to variouls communication channels', 1);
